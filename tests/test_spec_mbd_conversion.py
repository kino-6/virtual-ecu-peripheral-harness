...
def test_render_spec_mbd_cli_uses_sample_metadata_from_spec_path(tmp_path):
    ...
    assert "Review: PASS" in html
    assert "sampleValue=9</td><td>active=false; state=IDLE" in html
    assert "sampleValue=10</td><td>active=true; state=ACTIVE" in html
    assert "Script-generated by" in html
